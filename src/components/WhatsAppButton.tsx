...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-14 h-14 rounded-full bg-amber-500 hover:bg-amber-400 shadow-lg shadow-amber-500/25 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95">
